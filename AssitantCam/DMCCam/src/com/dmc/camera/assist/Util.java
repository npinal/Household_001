...
public class Util {
	...
	public static final String INTENT_DATA_SETTINGS_FLASH_AUTO			= "auto";
	public static final String INTENT_DATA_SETTINGS_FLASH_ON 			= "on";
	public static final String INTENT_DATA_SETTINGS_FLASH_OFF 			= "off";
	public static final String INTENT_DATA_SETTINGS_FLASH_RED_EYE 		= "red-eye";
	public static final String INTENT_DATA_SETTINGS_FLASH_TORCH 		= "torch";
	
	public	static final String INTENT_FLAG_SETTINGS_PICTURE_SIZE 		= "assistantcamera.flag.settings_PICTURE_SIZE";
