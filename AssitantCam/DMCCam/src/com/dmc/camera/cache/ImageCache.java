...
//    private static final boolean DEFAULT_DISK_CACHE_ENABLED = true;	// jihye
    private static final boolean DEFAULT_DISK_CACHE_ENABLED = false;	// jihye
    ...
    private static RetainFragment findOrCreateRetainFragment(FragmentManager fm) {
        ...
        */
    	...
    	if(fm != null){
    		mRetainFragment = (RetainFragment) fm.findFragmentByTag(TAG);
    	}
    	else{
